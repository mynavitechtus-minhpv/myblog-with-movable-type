...
# 管理用パスワード
$cf{password} = '5MCt~e8)nF';

# 管理アドレス
$cf{master} = 'admin@san-db.jp';
...
# パスワードファイル【サーバパス】
# → 正確にフルパスを記述すること
$cf{pwdfile} = '/var/www/vhosts/azcom-net.jp/httpdocs/member/.htpasswd';

# 会員ファイル【サーバパス】
# → 正確にフルパスを記述すること
$cf{memfile} = '/var/www/vhosts/azcom-net.jp/httpdocs/member_pass/private/member.dat';

# アクセスログファイル【サーバパス】
# → 正確にフルパスを記述すること
$cf{axsfile} = '/var/www/vhosts/azcom-net.jp/httpdocs/member_pass/private/pwlog.dat';
