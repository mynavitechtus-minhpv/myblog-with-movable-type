...
<tr>
	...
	<td><input type="submit" name="access_log" value="選択"></td>
	<td>アクセスログ集計</td>
</tr><tr>
...
EOM
	...
	if ($in{member_new}) {
		print qq|<td><input type="text" name="id" size="8" maxlength="8" style="ime-mode:inactive">\n|;
		print qq|(入力必須。英数字で8文字以内)</td></tr>\n|;
		print qq|<tr><th>パスワード</th>\n|;
		print qq|<td><input type="text" name="pw" size="8" maxlength="8" style="ime-mode:inactive">\n|;
		print qq|(入力必須。英数字で8文字以内)</td></tr>\n|;
	} else {
...
<tr>
	<th>パスワード</th>
	<td>
		<input type="password" name="pw1" size="10"> （英数字で8文字以内）<br>
		<input type="password" name="pw2" size="10"> （再度入力）
	</td>
</tr>
</table>
